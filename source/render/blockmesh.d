...
class BlockMesh
{
    ...
    public void buildFace(BlockFace face, vec3f offset)
    {
        Vertex[] verts;
        //enum1 = 0;
        ...
        case BlockFace.front:
            // dfmt off
            builder.push([
                Vertex(vec3f(0, 0, 1) + offset, vec2f(0.0, 1.0)), // 0
                Vertex(vec3f(1, 0, 1) + offset, vec2f(1.0, 1.0)), // 1
                Vertex(vec3f(1, 1, 1) + offset, vec2f(1.0, 0.0)), // 2
                
                Vertex(vec3f(0, 0, 1) + offset, vec2f(0.0, 1.0)), // 0
                Vertex(vec3f(1, 1, 1) + offset, vec2f(1.0, 0.0)), // 2
                Vertex(vec3f(0, 1, 1) + offset, vec2f(0.0, 0.0)), // 3
            ]);
            // dfmt on
            break;
        case BlockFace.back:
            // dfmt off
            builder.push([
                Vertex(vec3f(1, 1, 0) + offset, vec2f(1.0, 0.0)),// 6
                Vertex(vec3f(0, 1, 0) + offset, vec2f(0.0, 0.0)),// 5
                Vertex(vec3f(0, 0, 0) + offset, vec2f(0.0, 1.0)),// 4

                Vertex(vec3f(1, 0, 0) + offset, vec2f(1.0, 1.0)),// 7
                Vertex(vec3f(1, 1, 0) + offset, vec2f(1.0, 0.0)),// 6
                Vertex(vec3f(0, 0, 0) + offset, vec2f(0.0, 1.0)),// 4
            ]);
            // dfmt on
        ...
        case BlockFace.top:
            // dfmt off
            builder.push([
                Vertex(vec3f(1, 1, 1) + offset, vec2f(1.0, 0.0)),// 10
                Vertex(vec3f(0, 1, 1) + offset, vec2f(0.0, 0.0)),// 9
                Vertex(vec3f(0, 1, 0) + offset, vec2f(0.0, 1.0)),// 8

                Vertex(vec3f(1, 1, 0) + offset, vec2f(1.0, 1.0)),// 11
                Vertex(vec3f(1, 1, 1) + offset, vec2f(1.0, 0.0)),// 10
                Vertex(vec3f(0, 1, 0) + offset, vec2f(0.0, 1.0)),// 8
            ]);
            // dfmt on
        ...
        case BlockFace.bottom:
            // dfmt off
            builder.push([
                Vertex(vec3f(0, 0, 0) + offset, vec2f(0.0, 1.0)),// 9
                Vertex(vec3f(0, 0, 1) + offset, vec2f(0.0, 0.0)), // 10
                Vertex(vec3f(1, 0, 1) + offset, vec2f(1.0, 0.0)), // 11

                Vertex(vec3f(0, 0, 0) + offset, vec2f(0.0, 1.0)),// 12
                Vertex(vec3f(1, 0, 1) + offset, vec2f(1.0, 0.0)),// 13
                Vertex(vec3f(1, 0, 0) + offset, vec2f(1.0, 1.0)) // 14
            ]);
            // dfmt on
            break;
        case BlockFace.left:
